...
export const lawyers = [
  {
    id: 'dinh-tru',
    name: 'Luật sư Đình Trụ',
    role: 'Giám đốc Công ty T&A Consulting',
    initials: 'ĐT',
    photo: a1,
    paragraphs: [
  ...
  {
    id: 'annie-le',
    name: 'Luật sư Annie Le',
    role: 'Chuyên gia Đầu tư nước ngoài & Pháp lý doanh nghiệp',
    initials: 'AL',
    photo: a2,
    paragraphs: [
  ...
  },
  {
    ...
    photo: a3,
    paragraphs: [
      'Mr. Ngoc Huy Ve, chuyên gia pháp lý với kinh nghiệm thực tiễn trong lĩnh vực tư vấn và giải quyết tranh chấp về dân sự, đất đai, tài chính – ngân hàng, lao động, hôn nhân gia đình, hình sự, hành chính và các vấn đề pháp lý liên quan đến doanh nghiệp, thuế.',
      'Ông có thế mạnh chuyên sâu trong hoạt động thu hồi, xử lý nợ và giải quyết các vụ việc phức tạp liên quan đến nghĩa vụ tài chính và tài sản.',
    ],
  },
  {
    id: 'associates',
    name: 'Các Luật sư cộng sự',
    role: 'Đội ngũ Luật sư & Chuyên gia pháp lý',
    initials: 'T&A',
    paragraphs: [
      'Bên cạnh các luật sư chủ chốt, T&A Consulting còn có đội ngũ luật sư cộng sự và chuyên gia pháp lý giàu kinh nghiệm, sẵn sàng đồng hành cùng Quý khách trong mọi lĩnh vực pháp lý.',
      'Chúng tôi tự tin mang lại cho khách hàng những giải pháp tối ưu nhất – với tư duy thực chiến, sự tận tâm và cam kết bảo vệ quyền lợi của khách hàng đến cùng.',
    ],
  },
]
